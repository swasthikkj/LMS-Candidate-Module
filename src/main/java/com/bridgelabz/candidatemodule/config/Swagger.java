package com.bridgelabz.candidatemodule.config;
...
public class Swagger implements WebMvcConfigurer {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bridgelabz.candidatemodule.controller"))
                .paths(PathSelectors.any())
                .build()
                .apiInfo(apiInfo());
    }
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("candidatemodule",
                "APIs for E.",
                "1.0",
                "Terms of service",
                new Contact("candidatemodule", "http://bridgelabz.candidatemodule", "swasthikkj@gmail.com"),
                "Apache 2.0",
